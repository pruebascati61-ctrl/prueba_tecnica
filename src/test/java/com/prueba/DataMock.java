...
public class DataMock {
    ...
    static{
        ...
        PRICE_4_DTO = new PriceDTO(35455, 1, "1",LocalDateTime.of(2020, 6, 15, 10, 0, 0),  BigDecimal.valueOf(35.50));
        PRICE_5_DTO = new PriceDTO(35455, 1, "1",LocalDateTime.of(2020, 6, 15, 16, 0, 0),  BigDecimal.valueOf(35.50));
        LISTADTO.add(PRICE_1_DTO);
        LISTADTO.add(PRICE_2_DTO);
        LISTADTO.add(PRICE_3_DTO);
        LISTADTO.add(PRICE_4_DTO);
        LISTADTO.add(PRICE_5_DTO);
